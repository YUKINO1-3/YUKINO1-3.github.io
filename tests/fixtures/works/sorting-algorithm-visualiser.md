...
slug: fixture-sorting-algorithm-visualiser
date: 2026-09-05
lifecycle: published
...
evidence:
  ...
  outcome: The finished visualiser demonstrates bubble sort and insertion sort over identical arrays.
  validation: I checked recorded steps against hand-worked examples and tested the controls at narrow and wide layouts.
